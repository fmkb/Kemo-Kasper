...
if ($useAJAX) {
$includes.="var SUGGEST_TABLE = \"Accept_news_Chart_searchsuggest.php\";\r\n";
}
...
$(document).ready(function() {
	document.forms.editform.value_p_newsaccept.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_p_newsaccept,'advanced')};
	document.forms.editform.value1_p_newsaccept.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_p_newsaccept,'advanced1')};
	document.forms.editform.value_p_newsaccept.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_p_newsaccept,'advanced')};
	document.forms.editform.value1_p_newsaccept.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_p_newsaccept,'advanced1')};
});
</script>
...
//	edit format
$editformats["p_newsaccept"]="Text field";
...
{
$contents_block["begin"].="action=\"Accept_news_Chart_chart.php\" ";
}
...
$templatefile = "Accept_news_Chart_search.htm";
