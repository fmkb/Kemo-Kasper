...
//	d_datetime - Datetime
	$value="";
		$value = ProcessLargeText(GetData($data,"d_datetime", "Datetime"),"","",MODE_VIEW);
	$xt->assign("d_datetime_value",$value);
	$xt->assign("d_datetime_fieldblock",true);
////////////////////////////////////////////
//	d_from_p_id - 
	$value="";
		$value=DisplayLookupWizard("d_from_p_id",$data["d_from_p_id"],$data,$keylink,MODE_VIEW);
			
	$xt->assign("d_from_p_id_value",$value);
	$xt->assign("d_from_p_id_fieldblock",true);
////////////////////////////////////////////
//	d_to_p_id - 
	$value="";
		$value=DisplayLookupWizard("d_to_p_id",$data["d_to_p_id"],$data,$keylink,MODE_VIEW);
			
	$xt->assign("d_to_p_id_value",$value);
	$xt->assign("d_to_p_id_fieldblock",true);
////////////////////////////////////////////
//	d_message - 
	$value="";
		$value = ProcessLargeText(GetData($data,"d_message", ""),"","",MODE_VIEW);
	$xt->assign("d_message_value",$value);
