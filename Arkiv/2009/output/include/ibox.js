...
MIT Licensed Style
*********************************************************/
var indicator_img_path = "include/images/indicator.gif";
...
showIbox = function(url,title,params) {
	...
	var url2 = url;
	var urlType = url2.toLowerCase().match(urlString);	
	...
	// added by Sergey Kornilov on 11/05/2007
	ibox_type=1;
		...
		case 1:
			...
			imgPreloader.onload = function(){
				...
				if(loadCancelled == false) {
					...
					{
						imgPreloader.width+=28;
						imgPreloader.height+=48;
					}
