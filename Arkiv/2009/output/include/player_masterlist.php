...
//	p_first - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_first", ""),"field=p%5Ffirst".$keylink);
			$xt->assign("p_first_mastervalue",$value);

//	p_name - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_name", ""),"field=p%5Fname".$keylink);
			$xt->assign("p_name_mastervalue",$value);

//	p_zip - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_zip", ""),"field=p%5Fzip".$keylink);
			$xt->assign("p_zip_mastervalue",$value);

//	p_country - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_country", ""),"field=p%5Fcountry".$keylink);
...
//	p_mobile - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_mobile", ""),"field=p%5Fmobile".$keylink);
...
//	p_win - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_win", ""),"field=p%5Fwin".$keylink);
			$xt->assign("p_win_mastervalue",$value);

//	p_mk - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_mk", ""),"field=p%5Fmk".$keylink);
			$xt->assign("p_mk_mastervalue",$value);

//	p_born - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_born", ""),"field=p%5Fborn".$keylink);
			$xt->assign("p_born_mastervalue",$value);

//	p_ip - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_ip", ""),"field=p%5Fip".$keylink);
			$xt->assign("p_ip_mastervalue",$value);

//	p_datetime - Short Date
			$value="";
				$value = ProcessLargeText(GetData($data,"p_datetime", "Short Date"),"field=p%5Fdatetime".$keylink);
			$xt->assign("p_datetime_mastervalue",$value);

//	p_tscore - 
			$value="";
				$value = ProcessLargeText(GetData($data,"p_tscore", ""),"field=p%5Ftscore".$keylink);
			$xt->assign("p_tscore_mastervalue",$value);
	$strTableName=$oldTableName;
	$xt->display("player_masterlist.htm");
}
