...
//	ts_id - 
			$value="";
				$value = ProcessLargeText(GetData($data,"ts_id", ""),"field=ts%5Fid".$keylink);
			$xt->assign("ts_id_mastervalue",$value);

//	ts_p0 - 
			$value="";
				$value = ProcessLargeText(GetData($data,"ts_p0", ""),"field=ts%5Fp0".$keylink);
...
//	ts_name - 
			$value="";
				$value = ProcessLargeText(GetData($data,"ts_name", ""),"field=ts%5Fname".$keylink);
			$xt->assign("ts_name_mastervalue",$value);
	$strTableName=$oldTableName;
	$xt->display("teams_masterlist.htm");
}
