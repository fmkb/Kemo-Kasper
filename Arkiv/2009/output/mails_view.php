...
//	m_id - 
	$value="";
		$value = ProcessLargeText(GetData($data,"m_id", ""),"","",MODE_VIEW);
	$xt->assign("m_id_value",$value);
	$xt->assign("m_id_fieldblock",true);
////////////////////////////////////////////
//	m_name - 
	$value="";
		$value = ProcessLargeText(GetData($data,"m_name", ""),"","",MODE_VIEW);
	$xt->assign("m_name_value",$value);
	$xt->assign("m_name_fieldblock",true);
////////////////////////////////////////////
//	m_body - 
	$value="";
		$value = ProcessLargeText(GetData($data,"m_body", ""),"","",MODE_VIEW);
	$xt->assign("m_body_value",$value);
