...
//	r_id - 
	$value="";
		$value = ProcessLargeText(GetData($data,"r_id", ""),"","",MODE_VIEW);
	$xt->assign("r_id_value",$value);
	$xt->assign("r_id_fieldblock",true);
////////////////////////////////////////////
//	r_name - 
	$value="";
		$value = ProcessLargeText(GetData($data,"r_name", ""),"","",MODE_VIEW);
	$xt->assign("r_name_value",$value);
	$xt->assign("r_name_fieldblock",true);
////////////////////////////////////////////
//	r_img - 
	$value="";
		$value = ProcessLargeText(GetData($data,"r_img", ""),"","",MODE_VIEW);
	$xt->assign("r_img_value",$value);
	$xt->assign("r_img_fieldblock",true);
////////////////////////////////////////////
//	r_text - 
	$value="";
		$value = ProcessLargeText(GetData($data,"r_text", ""),"","",MODE_VIEW);
	$xt->assign("r_text_value",$value);
	$xt->assign("r_text_fieldblock",true);
////////////////////////////////////////////
//	r_date - Short Date
	$value="";
		$value = ProcessLargeText(GetData($data,"r_date", "Short Date"),"","",MODE_VIEW);
	$xt->assign("r_date_value",$value);
	$xt->assign("r_date_fieldblock",true);
////////////////////////////////////////////
//	r_p_id - 
	$value="";
		$value=DisplayLookupWizard("r_p_id",$data["r_p_id"],$data,$keylink,MODE_VIEW);
			
	$xt->assign("r_p_id_value",$value);
