...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
	...
	$searchField = GoodFieldName( postvalue('searchField') );
			...
			if ( $searchField == '' || $searchField=="s_active")
	{
		$field="s_active";
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_name")
	{
		$field="s_name";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_contact")
	{
		$field="s_contact";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_adr")
	{
		$field="s_adr";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_zip")
	{
		$field="s_zip";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_phone1")
	{
		$field="s_phone1";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_phone2")
	{
		$field="s_phone2";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_total")
	{
		$field="s_total";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_paid")
	{
		$field="s_paid";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_www")
	{
		$field="s_www";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="s_mail")
	{
		$field="s_mail";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			while ($row = db_fetch_numarray($rs)) {
				...
				if ($pos!==FALSE) {
					...
					if ( $searchField == '' || $searchField=="s_country")
	{
		$field="s_country";
		if(CheckFieldPermissions($field))
		{
