...
<br><br><input class=button type=submit value="<?php echo mlang_message("SAVE")?>" name=submit1>
<input class=button type=button onClick='window.close();return false;' value="<?php echo mlang_message("CLOSE_WINDOW")?>">
</div>
</form>
