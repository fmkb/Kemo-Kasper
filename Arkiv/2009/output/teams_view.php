...
//	ts_id - 
	$value="";
		$value = ProcessLargeText(GetData($data,"ts_id", ""),"","",MODE_VIEW);
	$xt->assign("ts_id_value",$value);
	$xt->assign("ts_id_fieldblock",true);
////////////////////////////////////////////
//	ts_p0 - 
	$value="";
		$value = ProcessLargeText(GetData($data,"ts_p0", ""),"","",MODE_VIEW);
	$xt->assign("ts_p0_value",$value);
	$xt->assign("ts_p0_fieldblock",true);
////////////////////////////////////////////
//	ts_s_id - 
	$value="";
		$value=DisplayLookupWizard("ts_s_id",$data["ts_s_id"],$data,$keylink,MODE_VIEW);
			
	$xt->assign("ts_s_id_value",$value);
	$xt->assign("ts_s_id_fieldblock",true);
////////////////////////////////////////////
//	ts_name - 
	$value="";
		$value = ProcessLargeText(GetData($data,"ts_name", ""),"","",MODE_VIEW);
	$xt->assign("ts_name_value",$value);
