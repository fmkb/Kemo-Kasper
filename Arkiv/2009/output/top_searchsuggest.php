...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
	...
	$searchField = GoodFieldName( postvalue('searchField') );
			...
			if ( $searchField == '' || $searchField=="t_id")
	{
		$field="t_id";
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="t_user")
	{
		$field="t_user";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="t_score")
	{
		$field="t_score";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			while ($row = db_fetch_numarray($rs)) {
				...
				if ( $searchField == '' || $searchField=="t_ip")
	{
		$field="t_ip";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="t_p_id")
	{
		$field="t_p_id";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="t_ts_id")
	{
		$field="t_ts_id";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="t_kills")
	{
		$field="t_kills";
		if(CheckFieldPermissions($field))
		{
