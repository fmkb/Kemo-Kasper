...
while($data)
{
	...
	$xt->assign("show_key1", htmlspecialchars(GetData($data,"xs_id", "")));
...
//	xs_id - 
	$value="";
		$value = ProcessLargeText(GetData($data,"xs_id", ""),"","",MODE_VIEW);
	$xt->assign("xs_id_value",$value);
	$xt->assign("xs_id_fieldblock",true);
////////////////////////////////////////////
//	xs_text - 
	$value="";
		$value = ProcessLargeText(GetData($data,"xs_text", ""),"","",MODE_VIEW);
	$xt->assign("xs_text_value",$value);
